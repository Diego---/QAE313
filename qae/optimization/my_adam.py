    ...
    def __init__(
        ...
        Args:
            ...
            callback: A callback function passed information in each iteration step. The
                ...
                the function value, the stepsize.
        """
        super().__init__()
        ...
        self._nfev = 0 # number of cost function evaluations
        self._m = np.zeros(1)
        self._v = np.zeros(1)
        if self._amsgrad:
